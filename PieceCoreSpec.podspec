#
#  Be sure to run `pod spec lint PieceCoreSpec.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "hamamoto" => "hamamoto@agailware.jp" }
  # Or just: s.author    = "hamamoto"
  # s.authors            = { "hamamoto" => "hamamoto@agailware.jp" }
  # s.social_media_url   = "http://twitter.com/hamamoto"
